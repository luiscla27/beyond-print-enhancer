...
- **Persistent Layout Management:** Provides a floating control panel to save custom section arrangements (coordinates, sizes, and internal scaling) to the browser (IndexedDB) or as local JSON files for portability. Includes automatic migration of legacy data and support for embedded custom assets.
