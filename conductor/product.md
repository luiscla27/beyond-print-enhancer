...
- **Layer Management:** Introduces a dedicated panel to toggle the visibility of 'Shapes Mode' and 'Sections' layers independently, allowing for better visual isolation and workspace management.
