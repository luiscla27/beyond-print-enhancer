...
- [ ] **Load Default Handling:** Ensure any new kind of section (clones, detail sections, etc.) is correctly repositioned or handled in `handleLoadDefault` (update `handleLoadDefault` in `main.js`). Note: Spell detail sections should default to `left: 1200px` (outside the main sheet limit).
