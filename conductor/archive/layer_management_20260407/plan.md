...
## Phase 6: Design Resilience
- [x] Task: Update project-level instructions (gemini.md) with Deep Clean and UI naming conventions.
- [x] Task: Add "UI Isolation & Deep Clean" verification step to the global workflow (workflow.md).
- [x] Task: Refactor implementation to follow new naming standards (print-enhance- and be- prefixes).
- [x] Task: Verify all tests pass with the refactored identifiers.
